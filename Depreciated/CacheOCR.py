...
def extract_text_from_paddleocr_result(result):
    ...
    if result and len(result) > 0:
        # PaddleOCR returns a list of [boxes, (text, confidence)]
        for line in result:
...
for file_path in file_paths:
    ...
    try:
        ...
        for page_num in range(doc.page_count):
            ...
            # img.save(f"C:/Users/BSSandbox/Desktop/PDFsorter/_workingdata_/Page{page_num}.jpg")    # Check what PaddleOCR is seeing if you want to
            ...
            try:
                ...
                ocr_text = extract_text_from_paddleocr_result(result)
                ...
                if matches:
                    ...
                    # print(f"drawing_number: {A_or_G_drawing_number}")    # Debug: print OCR drawing_number regex result
